...
allLoanInstorage.forEach((eachLoan) => {
            if (eachLoan.hasOwnProperty("normalLoan")) {
                allLoanToApproveHTML += `
                    <div class="loanRequestProfile" data-removed-id="${eachLoan.lpNumber}">
                        ...
                        <div class="loanAwaitingApproval">
                            <span>Loan: ${toNairaCurrency(eachLoan.normalLoan)}</span>
                        ...
                        <div class="guarantorDetails">
                            ...
                            <label for="firstGuarantoeProfile">${eachLoan.firstGuarantorId || "N/A"}</label>
                        </div>
                        <div class="guarantorDetails">
                            <input type="checkbox" name="${eachLoan.secondGuarantorId}">
                            <label for="secondGuarantoeProfile">${eachLoan.secondGuarantorId || "N/A"}</label>
                        </div>
                        <div class="loanAwaitingApproval">Date Applied: ${eachLoan.dateApplied}</div>
                        <div class="loanButtons">
                ...
                allLoanToApproveHTML += `
                    <div class="loanRequestProfile" data-removed-id="${eachLoan.lpNumber}">
                        ...
                        <div class="loanAwaitingApproval">
                            <span id="amountappliedFor">Loan: ${toNairaCurrency(eachLoan.specialLoan)}</span>
                            <span>Interest: ${toNairaCurrency(eachLoan.interest)}</span>
                        </div>
                        <div class="loanAwaitingApproval">
                            <span>Total: ${toNairaCurrency(eachLoan.total)}</span>
